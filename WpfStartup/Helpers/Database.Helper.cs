...
//	/// ConnectionString and DefaultConnection are available to help create a new SQLCommand,
...
//				try
//				{
//					conn = new SqlConnection(Helpers.Database_old.ConnectionString);					
//					conn.Open();
//				}
//				catch (Exception ex)
//				{
...
//		/// <returns></returns>
//		public static SqlCommand GetCommand(string command, List<SqlParameter> parameters = null, bool maintainConnection = false)
//		{
...
//		public static void CloseReader(SqlDataReader dataReader, SqlCommand command = null, bool closeConnection = true)
//		{
