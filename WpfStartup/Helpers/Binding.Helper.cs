...
{		
	...
	#region Validation By Rules List
		...
		public static void BindInputPropertyToObject(Control control, string propertyName, Object dataObject, List<ValidationRule> validationRules = null, bool useNotification = false)
		{
			if (control is IInputElement && propertyName != "" && dataObject != null)
			{
				Binding b = new Binding(propertyName);
	...
	#region Validation By Types List
		...
		/// <param name="useNotification">true/false Use Main Window notification</param>
		public static void BindInputPropertyToObject(Control control, string propertyName, Object dataObject, List<ValidationType> types, bool useNotification = false)
		{
			if (control is IInputElement && propertyName != "" && dataObject != null)
			{
				Binding b = new Binding(propertyName);
	...
	#region Validation By Rule
		...
		public static void BindInputPropertyToObject(Control control, string propertyName, Object dataObject, ValidationRule validationRule = null, bool useNotification = false)
		{
			if (control is IInputElement && propertyName != "" && dataObject != null)
			{
				Binding b = new Binding(propertyName);
	...
	#region Validation By Type
		...
		/// <param name="useNotification">true/false Use Main Window notification</param>
		public static void BindInputPropertyToObject(Control control, string propertyName, Object dataObject, ValidationType type, bool useNotification = false)
		{
			if (control is IInputElement && propertyName != "" && dataObject != null)
			{				
				Binding b = new Binding(propertyName);
		...
		/// <param name="dataObject">The object contining the property name to bind to.</param>        
		/// <param name="useNotification">true/false Use Main Window notification</param>
		public static void BindCheckbox(Control control, string propertyName, Object dataObject, bool useNotification = false)
		{            
			Binding b = new Binding(propertyName);
			b.NotifyOnValidationError = true;
			b.Source = dataObject;
